...
const NAME_GENDER = {
  ...
  אביחי: 'm', אברהם: 'm', אבשלום: 'm', אליהו: 'm', אלישיב: 'm', אלכסנדר: 'm',
  אמציה: 'm', אריאל: 'm', ברוך: 'm', ויטלי: 'm', זאב: 'm', חנוך: 'm', חיים: 'm',
  ...
  אורנה: 'f', אילה: 'f', אלמז: 'f', אסתר: 'f', אתי: 'f', חדוה: 'f', כוכבה: 'f',
  צפורה: 'f', רחל: 'f', מאי: 'f',
};
